...
<div class="col-span-6 p-4">
        <a href="<?php echo e(route ('guru.create')); ?>"><button class="px-4 py-1 text-sm rounded bg-white text-blue-600 font-semibold border border-blue-200 hover:text-white hover:bg-blue-600 hover:border-transparent focus:outline-none">Tambah</button>
       </a>
...
<div class="rounded sm:px-1 sm:px-1 sm:bg-gray-100">
    ...
    <tbody class="divide-y divide-gray-200">
        ...
        <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <td class="px-6 py-4 whitespace-nowrap"><?php echo e($guru->jabatan); ?></td>
            <td class="px-6 py-4 whitespace-nowrap" >
            <a href="<?php echo e(route('guru.edit',$guru->id )); ?>"><button class="px-4 py-1 text-sm rounded text-green-600 font-semibold border border-green-200 hover:text-white hover:bg-green-600 hover:border-transparent focus:outline-none">Edit</button></a> | 
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\tugas-laravel\resources\views/admin/guru.blade.php ENDPATH**/ ?>